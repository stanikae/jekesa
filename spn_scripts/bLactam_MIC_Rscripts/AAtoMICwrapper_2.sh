...
#Stanford commented #scrdir="/scicomp/groups/OID/NCIRD/DBD/RDB/Strep_Lab/External/share/PBP_AA_to_MIC/"
#Stanford commented #cp $scrdir"scripts/Ref_PBP_3.faa" .
cp $SPN_SCRIPTS_DIR/bLactam_MIC_Rscripts/Ref_PBP_3.faa .
cp $AAseqDir"/"*".faa" .

#module load clustal-omega/1.2
#Stanford commented #scr1="/scicomp/groups/OID/NCIRD/DBD/RDB/Strep_Lab/External/share/PBP_AA_to_MIC/scripts/Build_PBP_AA_tableR3.2.2.R"
scr1="$SPN_SCRIPTS_DIR/bLactam_MIC_Rscripts/Build_PBP_AA_tableR3.2.2.R"
Rscript $scr1 $faaDir
